...
sendgrid.setApiKey("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");
//console.log("PASSEI")
async function sendEmail(req, res) {
  ...
  try {
    ...
    await sendgrid.send({
      to: "hugogontijomachado@gmail.com", // Your email where you'll receive emails
      from: "hugogontijomachado@gmail.com", // your website email address here
